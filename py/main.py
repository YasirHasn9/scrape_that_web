...
# Declare a function called scrape_page with a parameter(string) called url. 
# Inside the function make a get request to the page with that url 
# the request will give you a response. 
# The response now holds the content. To extract the content, we need to understand what data type is the content.
# Simple the content is the html, isn't that amazing you lucky bastard?
# Yes bastred, I mean with one click and you can bring the whole page, and majority of the code is already written for you.
# Btw, I love this 

# Now to parse the html, lucky for us-- again bastard -- python has an already developed 
# a library or package --- names do not matter --- that can scrape the web called bs4
# and apparently, <and i wish my spelling is correct, and I dont know how to trun on the spell_checking function in cursor> that this library has a function 
...
# Well, gentlemen, im so lazy, I like things that are already built for me 
...
# Idk why, this remains me of the reducer function in React-hooks - FUCK REACT <Kidding, am I tho?>.

# And since this beautiful sexy lady named is BeautifulSoup, we are gonna name it soup
# You see sometimes beauty forces you to compromise, especially if you are in a despair for it.
# Sweetheart do not judge me, Need makes me comply, and I know the less I need the happier Iam 

# The value soup has, is the html in that page. For now, im only interested in it a for learning purpose 
